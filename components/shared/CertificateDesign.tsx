                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '12px' }}>
                            <thead>
                                <tr style={{ backgroundColor: '#e8e8e8' }}>
                                    ...
                                    <th style={{ ...tc, width: '130px', textAlign: 'center' }}>Date of Birth</th>
                            ...
                            <tbody>
                                {heirs.map((heir, i) => (
                                    <tr key={i}>
                                        ...
                                        <td style={{ ...tc }}>{toTitleCase(heir.nameEn || heir.name || '')}</td>
                                        <td style={{ ...tc, textAlign: 'center' }}>{toSentenceCase(heir.relation || '')}</td>
                                        <td style={{ ...tc, textAlign: 'center' }}>{formatBirthDate(heir.dob)}</td>
                                        <td style={{ ...tc, textAlign: 'center' }}>{heir.nid}</td>
                                    </tr>
                                ))}
                                <tr style={{ backgroundColor: '#f5f5f5' }}>
                                    <td colSpan={5} style={{ ...tc, fontWeight: 'bold', textAlign: 'right' }}>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '12px' }}>
                        <thead>
                            <tr style={{ backgroundColor: '#e8e8e8' }}>
                                ...
                                <th style={{ ...tc, width: '130px', textAlign: 'center' }}>জন্ম তারিখ</th>
                        ...
                        <tbody>
                            {heirs.map((heir, i) => (
                                <tr key={i}>
                                    <td style={{ ...tc, textAlign: 'center' }}>{i + 1}</td>
                                    <td style={{ ...tc, textAlign: 'center' }}>{heir.nameBn || heir.name}</td>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '12px' }}>
                            ...
                            <tbody>
                                {members.map((m, i) => (
                                    <tr key={i}>
                                        <td style={{ ...tc, textAlign: 'center' }}>{i + 1}</td>
                                        <td style={{ ...tc }}>{toTitleCase(m.nameEn || m.name || '')}</td>
                                        <td style={{ ...tc, textAlign: 'center' }}>{toSentenceCase(m.relation || '')}</td>
                                        <td style={{ ...tc, textAlign: 'center' }}>{formatBirthDate(m.dob)}</td>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '12px' }}>
                        ...
                        <tbody>
                            {members.map((m, i) => (
                                <tr key={i}>
                                    <td style={{ ...tc, textAlign: 'center' }}>{i + 1}</td>
                                    <td style={{ ...tc, textAlign: 'center' }}>{m.nameBn || m.name}</td>
