...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            {mobileOpen && (
                <div
                    className="fixed inset-0 z-[3100] bg-black/60 backdrop-blur-sm md:hidden transition-opacity"
            ...
            <aside
                className={cn(
                    'fixed bottom-0 left-0 top-0 z-[3200] flex flex-col border-r border-border bg-card transition-all duration-300 ease-in-out md:translate-x-0',
