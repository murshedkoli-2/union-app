    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/citizens', {
                ...
                body: JSON.stringify({
                    ...formData,
                    status: 'approved' // Admin created citizens are automatically approved
                })
            });
            ...
            if (res.ok) {
                ...
                toast.error(data.error || 'Failed to register citizen');
            }
        } catch (error) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground font-display">Register New Citizen</h1>
                    <p className="text-muted-foreground mt-1">Add a new citizen to the union database.</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium">Father's Name (Bangla)</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium">Mother's Name (Bangla)</label>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-medium">NID / Birth Registration No</label>
                    ...
                    {/* Address */}
                    <div className="space-y-4">
                        <h3 className="text-lg font-semibold border-b border-border pb-2">Present Address</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-medium">Village/Mahalla</label>
