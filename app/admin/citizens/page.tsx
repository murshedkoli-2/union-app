    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground font-display">Manage Citizens</h1>
                    <p className="text-muted-foreground mt-1">View and manage registered citizens.</p>
                </div>
                <Link
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-muted/50">
                            <tr className="border-b border-border">
                                ...
                                <th className="px-6 py-4 text-left font-semibold text-muted-foreground">NID</th>
                                <th className="px-6 py-4 text-left font-semibold text-muted-foreground">Status</th>
                                <th className="px-6 py-4 text-left font-semibold text-muted-foreground">Address</th>
                        ...
                        <tbody className="divide-y divide-border">
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={5} className="px-6 py-12 text-center text-muted-foreground">No citizens found.</td>
                                </tr>
                            ) : (
